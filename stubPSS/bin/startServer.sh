...
echo "Starting StubPSS version:$vers context:$context"
java   -Xmx256m -Djava.net.preferIPv4Stack=true -jar $OSCARS_DIST/stubPSS/target/stubPSS-$vers.one-jar.jar -c $context  &
