...
public class QueryTCE extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // Send a QueryTCE request 
            Object[] req = new Object[]{subjectAttrs,createReq};
            Object[] res = coordClient.invoke("QueryTCE",req);
            ...
            this.log.error(netLogger.error(methodName, ErrSev.MAJOR,"caught exception  invoking QueryTCE " + 
                                            ex.toString()));
            ex.printStackTrace();
