...
public class StubPSSClient extends OSCARSSoapService<PSSService, PSSPortType>  {
    static private Logger LOG = Logger.getLogger(StubPSSClient.class);

    private StubPSSClient (URL host, URL wsdlFile) throws OSCARSServiceException {
        super (host, wsdlFile, PSSPortType.class);
    }

    static public StubPSSClient getClient (URL host, URL wsdl)
        ...
        try {
            ...
            LOG.error(netLogger.error("StubPSSClient.getClient", ErrSev.MAJOR, " caughtException: " + e.getMessage()));
            e.printStackTrace();
            throw new OSCARSServiceException(e.getMessage());
        }
        StubPSSClient client = new StubPSSClient (host, wsdl);
        return client;
    }
